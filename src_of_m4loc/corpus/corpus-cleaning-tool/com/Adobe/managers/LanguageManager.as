...
//		private var _selLangCollection:ArrayCollection = new ArrayCollection();
		...
		public function set allLanguages(langList:ArrayCollection):void
		{
...
//		[Bindable(event="allLanguagesChanged")]
		public function get allLanguages():ArrayCollection
		{
			var allLanguages:ArrayCollection = new ArrayCollection();
			var myXmlUtil:XMLUtility = new XMLUtility();
			
			allLanguages.source = myXmlUtil.XMLList2Array(_allLanguages.children())
			return allLanguages;
		}
