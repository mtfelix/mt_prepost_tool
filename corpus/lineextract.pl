...
#
# Extract lines from a text file based on line numbers file (zero-indexed)
#
...
This tool reads a text corpus from standard input and a line numbers (zero-indexed) from C<linesfile>. It outputs the text corpus lines specified in the line numbers file to standard output.
